...
class RuleResource(ModelResource):
    created_by = fields.Field(
        column_name="created_by", attribute="created_by", widget=ForeignKeyWidget(get_user_model(), "username")
    )

    updated_by = fields.Field(
        column_name="updated_by", attribute="created_by", widget=ForeignKeyWidget(get_user_model(), "username")
    )
...
class RuleCommitResource(ModelResource):
    rule = fields.Field(column_name="rule", attribute="rule", widget=ForeignKeyWidget(get_user_model(), "name"))
    updated_by = fields.Field(
        column_name="updated_by", attribute="created_by", widget=ForeignKeyWidget(get_user_model(), "username")
    )
